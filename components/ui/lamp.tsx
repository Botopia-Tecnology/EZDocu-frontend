...
export function LampContainer({
    ...
    return (
        <div
            className={cn(
                "relative flex min-h-[600px] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0 bg-gray-50",
                className
            )}
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
                ...
                <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-gray-50 blur-[8rem]"></div>
